...
This is a current PME preference in 2.1.0-beta.5. It changes the extra visual gap; it does not add commands or change the underlying Blender Pie Menu theme.
